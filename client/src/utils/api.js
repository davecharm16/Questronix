...
export const updateProduct = `${host}/product`;
export const updateProductDisable = `${host}/product/disable`;
export const deleteProductRoute = `${host}/product`;
// http://localhost:5000/product/6
